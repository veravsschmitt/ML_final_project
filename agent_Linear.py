...
class DQN_Linear_Agent:
    def __init__(self, state_size, action_size):

        self.model = DQN_Linear(state_size, action_size)                       #constructing model that will learn
        self.target_model = DQN_Linear(state_size, action_size)                #constructing second model for stabilization (this always gets updated with the actual model)
